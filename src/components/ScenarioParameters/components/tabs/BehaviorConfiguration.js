...
import { BasicNumberInput, BasicToggleInput } from '@cosmotech/ui';
    ...
    <Grid container>
      <Grid container>
        <Grid container item xs={4}>
          ...
          <Tooltip
              title={ t('genericcomponent.text.scenario.parameters.behavior.manage_backlog.tooltip',
      ...
      <Grid container>
        <Grid container item xs={4}>
          ...
          <Tooltip
              title={t('genericcomponent.text.scenario.parameters.behavior.obsolete_stock.tooltip',
      ...
      <Grid container>
        <Grid container item xs={4}>
          ...
          <Tooltip
              title={t('genericcomponent.text.scenario.parameters.behavior.financial_cost.tooltip',
