...
const TimeConfiguration = ({
  ...
  const endDateProps = {
    ...
    minDateMessage: t('genericcomponent.text.scenario.parameters.time_configuration.date_boundaries_error',
  ...
  return (
    <Grid container direction="column" justifyContent="center" alignItems="flex-start">
      <BasicEnumInput
        label={ t('genericcomponent.text.scenario.parameters.time_configuration.simulation_granularity',
